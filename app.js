...
require("./mernbackend/src/db/conn");
const Register = require("./mernbackend/src/models/register");
const port =  3000;

const static_path = path.join(__dirname,"./mernbackend/public");
const template_path = path.join(__dirname,"./mernbackend/templates/views");
const partials_path = path.join(__dirname,"./mernbackend/templates/partials");
//postman
